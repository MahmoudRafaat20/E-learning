        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="[&>th]:border-b [&>th]:py-2">
              <th className="dark:text-zinc-100">Title</th>
              <th className="dark:text-zinc-100">Lesson</th>
              <th className="dark:text-zinc-100">Owner</th>
              <th className="dark:text-zinc-100">Status</th>
              <th style={{ width: 220 }} className="dark:text-zinc-100">
                Actions
              </th>
            </tr>
          </thead>
          <tbody>
            {exams.map((e) => (
              <tr
                ...
                <td className="dark:text-zinc-100">{e.title}</td>
                <td className="dark:text-zinc-100">{e.lesson}</td>
                <td className="dark:text-zinc-100">{e.owner}</td>
                <td className="dark:text-zinc-100">
                  {e.published ? "Published" : "Draft"}
                </td>
                <td className="space-x-2">
                  <button
                    className="px-2 py-1 rounded border dark:text-zinc-100"
